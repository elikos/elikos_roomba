...
| :------------------ | :-------------------- |:------------------------------------------------------------------------------------------------------- |
|  subscribes         | `/bumper`             | Bumper state message (published by `create_autonomy`)                                                   |
|  publishes          | `/cmd_vel`            | Drives the robot's wheels according to a forward and angular velocity (`create_autonomy` is subscribed) |
