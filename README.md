...
`elikos_roomba` works with the [`create_autonomy`](https://github.com/AutonomyLab/create_autonomy) package to communicate with and drive the Roomba with ROS. Its purpose is to implement the [IARC mission 7](http://www.aerialroboticscompetition.org/mission7.php) ground robot and obstacle [behaviours](#robot-behaviour).
...
Behaviour description of the ground robot and obstacle robot according to the [official rules](http://www.aerialroboticscompetition.org/assets/downloads/mission7rules_legacy.pdf).
